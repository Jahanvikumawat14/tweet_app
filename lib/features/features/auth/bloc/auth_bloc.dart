...
import 'package:flutter_workshop_tweet_app/features/features/auth/models/user_model.dart';
import 'package:flutter_workshop_tweet_app/features/features/auth/repos/auth_repo.dart';
  ...
  Future<FutureOr<void>> authenticationEvent(
    ...
    if (credential != null) {
      if (event.authType == AuthType.login) {
        UserModel? userModel = await AuthRepo.getUserRepo(
